...
### By Everlyn Njeri 10/11/2023

## Demo

![ Demo-when page loads](./public/demo/demo-ArtGallery.png "Art Gallery Demo")
![ Demo-art details](./public/demo/demo.gif "Art Gallery Demo")
...
* View ongoing exhibitions and artworks section when the page loads.
...
1. To install **Art Gallery**, follow these steps:

Linux and Mac OS:

```bash
sudo git clone https://github.com/codeitownit/phase-2-project.git
```

Windows:
```bash
git clone https://github.com/codeitownit/phase-2-project.git
```

2. Running the project

Open the project directory in a code editor and view by running **npm start**.
